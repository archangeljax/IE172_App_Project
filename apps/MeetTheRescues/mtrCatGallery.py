                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/cats/Zeta', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=cats[0]["profile"],
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/cats/Tau', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=cats[1]["profile"],
                                    className="d-flex justify-content-center"
                                )
                            ]
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/cats/Gamma', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=cats[2]["profile"],
                                    className="d-flex justify-content-center"
                                )
                            ]
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/cats/Rho', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=cats[3]["profile"],
                                    className="d-flex justify-content-center"
                                )
                            ]
