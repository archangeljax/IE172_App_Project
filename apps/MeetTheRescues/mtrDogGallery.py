...
layout = html.Div(
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/dogs/Alpha', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=dogs[0]["profile"],
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/dogs/Charlie', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=dogs[1]["profile"],
                                    className="d-flex justify-content-center"
                                )
                            ]
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/dogs/Buddy', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=dogs[2]["profile"],
                                    className="d-flex justify-content-center"
                                )
                            ]
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.A(
                                    dbc.Button("ABOUT ME", color="secondary", href='/meetTheRescues/dogs/Delta', outline=True, className="mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                    href=dogs[3]["profile"],
                                    className="d-flex justify-content-center"
                                )
                            ]
    ...
    className="main-body",
    style={"paddingTop": "10px", "paddingLeft": "150px", "paddingRight": "150px", "paddingBottom": "10px", "backgroundColor": "#FAF3EB"}
)