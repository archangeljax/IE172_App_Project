        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    html.Div(
                        [
                            html.H1("Zeta"),  # Name of the pet
                            html.H4("Gender: Female"),
                            html.H4("Age: Almost Adult"),
                            html.H4("Breed: Scottish Fold"),
                            html.H4("Medical Condition: vaccinated and neutered, healthy"),
                            html.H4("Description: I live in UP Diliman Quezon City"),
