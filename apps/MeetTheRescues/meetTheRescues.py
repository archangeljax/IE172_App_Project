                                    ...
                                    dbc.CardImgOverlay(
                                        dbc.CardBody(
                                            [
                                                ...
                                                dbc.Button("DOGS", href="/meetTheRescues/dogs", className="btn-custom mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                            ],
                                        ),
                                    ),
                                ],
                                    ...
                                    dbc.CardImgOverlay(
                                        dbc.CardBody(
                                            [
                                                ...
                                                dbc.Button("CATS", href="/meetTheRescues/cats", className="btn-custom mx-1", style={'font-family': 'Roboto', 'margin-top': '10px'}),
                                            ],
                                        ),
                                    ),
                                ],
